...
```bash
git clone https://github.com/your-username/healthcare-visualization.git
...
Download `healthcare.csv` from [Kaggle](https://www.kaggle.com/datasets/abbas829/healthcare-patient-analytics-dataset) and place it in the project folder.
...
All 6 charts will be displayed and saved as `.png` files in the same folder.
